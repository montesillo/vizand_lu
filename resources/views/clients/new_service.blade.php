...
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    ...
    {!! Form::open(['url' => 'services', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
    {{ csrf_field() }}
    <div>
    ...
    <span class="btn btn-primary btn-file" style="margin-left: 10px">
    Elegir foto <input type="file" name="foto" id="foto" required>
    </span>
